...
export const getArrowOffsetToken = (options: { contentRadius: number; limitVerticalRadius?: boolean }): ArrowOffsetToken => {
...
export const getOverflowOptions = (placement: string, arrowOffset: ReturnType<typeof getArrowOffsetToken>, arrowWidth: number, autoAdjustOverflow?: boolean | AdjustOverflow) => {
...
const DisableAutoArrowList: Set<keyof BuildInPlacements> = new Set(['topLeft', 'topRight', 'bottomLeft', 'bottomRight', 'leftTop', 'leftBottom', 'rightTop', 'rightBottom']);
